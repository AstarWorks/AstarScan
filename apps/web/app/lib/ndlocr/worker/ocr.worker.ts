// @ts-nocheck — vendored from ndlocr-lite-web-ai (CC BY 4.0)
/**
 * OCR Web Worker
 * バックグラウンドでOCR処理を実行
...
class OCRWorker {
  ...
  async initialize(
    layoutOnly = false,
    language: RecognitionLanguage = 'ja',
  ): Promise<void> {
    ...
    try {
      ...
      if (layoutOnly) {
        ...
        this.post({
          ...
          progress: 0.76,
          message: 'Preparing layout model...',
        })
        ...
        this.post({
          ...
          stage: 'initializing_models',
          progress: 0.9,
          message: 'Preparing recognition model (European)...',
        })
        ...
        const [layoutModelData, rec30Data, rec50Data, rec100Data] =
          await Promise.all([
            loadModel('layout', (p) => {
              progresses.layout = p
              reportProgress()
            }),
            loadModel('recognition30', (p) => {
              progresses.rec30 = p
              reportProgress()
            }),
            loadModel('recognition50', (p) => {
              progresses.rec50 = p
              reportProgress()
            }),
            loadModel('recognition100', (p) => {
              progresses.rec100 = p
              reportProgress()
            }),
          ])
        ...
        this.post({
          ...
          stage: 'initializing_models',
          progress: 0.83,
          message: 'Preparing recognition model (30)...',
        })
        ...
        this.post({
          ...
          stage: 'initializing_models',
          progress: 0.9,
          message: 'Preparing recognition model (50)...',
        })
        ...
        this.post({
          ...
          stage: 'initializing_models',
          progress: 0.96,
          message: 'Preparing recognition model (100)...',
        })
  ...
  async processOCR(
    ...
    try {
      ...
      const { lines: textRegions, blocks: pageBlocks } =
        await this.layoutDetector!.detect(imageData, (progress) => {
          this.post({
            type: 'OCR_PROGRESS',
            id,
            stage: 'layout_detection',
      ...
      const croppedImages = TextRecognizer.cropImageDataBatch(
        imageData,
        textRegions,
      )
      ...
      const orderedResults = this.readingOrderProcessor.process(
        recognitionResults,
        pageBlocks,
      )
